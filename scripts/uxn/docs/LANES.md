# Lane log — how every piece here was built and proved

This is the engineering record the README's map points at, in the order it happened
(2026-07-20 → 2026-07-24). It is deliberately long: each lane states what was built, the
regression it catches, the test that was **seen red** before it was green, and — where the
claim is narrower than it looks — what it does *not* prove. Read the README first for the
map; read a section here when you want the argument behind one box on it.

## uxn-pilot-gate — the original pilot (2026-07-20)
