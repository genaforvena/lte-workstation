...
Task: `unblock/adint/9408d7f1f2f1225b/resolve`
...
Complete this resolver with the audit result. Keep the witness parent blocked and preserve its retry
and terminal deadline. The existing wait-for successor remains responsible for checking the parent's
eventual outcome; at the next review, rerun the scorer and evaluate the frozen gate only after both
the time and sample thresholds are satisfied.
